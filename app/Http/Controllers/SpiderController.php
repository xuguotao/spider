...
class SpiderController extends Controller
{
    ...
    public function validateCode()
    {
        ...
        $validateCodeNum = $this->validateCodeService->getCodeNumberFromImage($validateCodeImage);
    ...
    private function insertStudents()
    {
        ...
        \DB::beginTransaction();
        try {
            foreach ($userList as $studentName) {
                Students::insert(['student_name' => $studentName]);
            }
            \DB::commit();
        } catch (\Exception $e) {
            \DB::rollBack();
